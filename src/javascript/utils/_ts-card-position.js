        ...
        this.callParent([
            '<div class="artifact">',
                ...
                '<div class="r3">',
                    ...
                    '</tpl>',
                    '<tpl if="this.displayFields.r3middleleft">',
                        '<span class="r3middleleft">{[this.getContent(values, this.displayFields.r3middleleft)]}</span>',
                    '</tpl>',
                    '<tpl if="this.displayFields.r3middleright">',
                        '<span class="r3middleright">{[this.getContent(values, this.displayFields.r3middleright)]}</span>',
                    '</tpl>',
